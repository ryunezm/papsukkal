...
export class SubgenreValidatorService {
  private genreSubgenreMap = new Map<Genre, SubGenre[]>([
    ...
    [Genre.ADVENTURE, [SubGenre.ADVENTURE_PIRATE, SubGenre.ADVENTURE_SURVIVAL, SubGenre.ADVENTURE_SWASHBUCKLER]],
    ...
    [Genre.HORROR, [SubGenre.HORROR_DEMONIC, SubGenre.HORROR_FOUND_FOOTAGE, SubGenre.HORROR_GORE, SubGenre.HORROR_MONSTER, SubGenre.HORROR_PARANORMAL, SubGenre.HORROR_SLASHER, SubGenre.HORROR_SURVIVAL, SubGenre.HORROR_WITCHCRAFT]],
