...
public enum Genre {
    ...
    ADVENTURE(Arrays.asList(SubGenre.ADVENTURE_PIRATE, SubGenre.ADVENTURE_SURVIVAL, SubGenre.ADVENTURE_SWASHBUCKLER)),
    ...
    HORROR(Arrays.asList(SubGenre.HORROR_DEMONIC, SubGenre.HORROR_FOUND_FOOTAGE, SubGenre.HORROR_GORE, SubGenre.HORROR_MONSTER, SubGenre.HORROR_PARANORMAL, SubGenre.HORROR_SLASHER, SubGenre.HORROR_SURVIVAL, SubGenre.HORROR_WITCHCRAFT)),
